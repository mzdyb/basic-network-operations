...
1. Create backup
2. Create configuration inventory (SoT) for brownfield network
...
It this case both backup and configuration inventory are copied to external server (backup host) but another use case might be to copy them to Version Control system like GitHub or GitLab.
...
To showcase use cases defined in this project two automation workflows have been created:
1. Create backup and configuration inventory (SoT) for brownfield network
![image](https://github.com/user-attachments/assets/e077f311-828e-4ab6-882c-ce66f09ded69)
This workflow creates network configuration backup and variable files with configuration data.
